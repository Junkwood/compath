  ...
  <header
    ...
    :class="[
      variant === 'v2' || variant === 'v3'
        ? 'before:bg-[#f5f6f8] after:absolute after:h-px after:inset-x-0 after:top-full after:bg-gray-200 dark:after:bg-gray-700/60 after:-z-10'
        : 'max-lg:shadow-xs lg:before:bg-[#f5f6f8]/90 dark:lg:before:bg-gray-900/90',
