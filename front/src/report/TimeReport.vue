      ...
      <main class="page">
        ...
        <div class="list-card">
          <div class="list-topbar">
            <span class="count-badge" v-if="reportList.length > 0"
              >총 {{ reportList.length }}건</span
            >
            <span v-else></span>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th class="col-task">업무명</th>
                  <th class="col-date">최근 작업일</th>
                  <th class="col-type">업무유형</th>
                  <th class="col-assignee">담당자</th>
                  <th class="col-hours">총 소요시간</th>
                </tr>
              </thead>
              <tbody>
                <tr v-if="loading">
                ...
                <template v-else>
                  ...
                  >
                    ...
                    <td class="col-project">
                      ...
                      <span v-if="item.subProjectName" class="project-sub"
                        >└ {{ item.subProjectName }}</span
                      >
                    </td>
                    <td class="col-task task-name">{{ item.title }}</td>
                    <td class="col-date td-center">
                      {{ formatDate(item.lastWorkDate) }}
                    </td>
                    <td class="col-type td-center">
                      <span class="badge" :class="`badge--${item.typeName}`">{{
                        item.typeName
                      }}</span>
                    </td>
                    <td class="col-assignee td-center">
                      <div class="assignee-cell">
                        <div class="avatar">{{ item.userName?.[0] }}</div>
                        {{ item.userName }}
                      </div>
                    </td>
                    <td class="col-hours td-right">
                      <span class="time-link">{{ item.totalHours }}시간</span>
                    </td>
                  </tr>
                </template>
                <tr class="total-row">
