<template>
  <div class="flex h-screen overflow-hidden">
    ...
    >
      ...
      <div
        class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-xs rounded-xl"
      >
        <header
          ...
          <div class="overflow-x-auto">
            <table class="table-auto w-full dark:text-gray-300">
              ...
              >
                <tr>
                  <th class="p-2">
                    <div class="font-semibold text-left">업무명</div>
                  </th>
                  <th class="p-2">
...
onBeforeMount(async () => {
  ...
  list = await axios.get("/api/tasks/" + id);
