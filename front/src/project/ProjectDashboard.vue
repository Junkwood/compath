...
// ── 나의 메모 (하드코딩) ─────────────────────────────
const memoList = ref([
  { id: 1, date: '2026.03.19 1PM', text: '클라이언트 미팅 소회의실 1', colorClass: 'memo-blue'  },
  { id: 2, date: '',               text: '파일섬 프로젝트\n요구사항 명세서 업로드', colorClass: 'memo-green' },
  { id: 3, date: '',               text: '베고프다\n내일 점심 머릭지 > <',         colorClass: 'memo-pink'  },
])
...
const handleAddMemo         = () => { /* TODO: 메모 추가 모달 */ }
